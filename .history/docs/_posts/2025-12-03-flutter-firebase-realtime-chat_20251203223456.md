...
- Cloud Firestore의 구조
    ...
    ![Firebase Cloud Firestore 구조.png](/assets/png/Firebase_Cloud_Firestore.png)
...
- Database 구조는 컬렉션을 두개로 나누어
    ...
    ![스크린샷 2023-04-25 오전 11.38.04.png](/assets/png/Firebase_login_1.PNG)
    
    - 모든 유저가 쓴 채팅창을 보관하는 Chat 컬렉션을 구조로 잡았다.
    
    ![스크린샷 2023-04-25 오전 11.38.41.png](/assets/png/Firebase_login_2.PNG)
